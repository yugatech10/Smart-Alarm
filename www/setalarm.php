...
<html> 
	<head> 
		...
		.button { background-color: #4CAF50; /* Green */ border: none; color: white; padding: 
		...
		.left{ float: left; width: 50%; margin-top:50px;
		}
		.right{ float: right; width: 50%; margin-top:50px;
		}
		#customers {
